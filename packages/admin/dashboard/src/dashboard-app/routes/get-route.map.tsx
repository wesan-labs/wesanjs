      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              errorElement: <ErrorBoundary />,
              lazy: () => import("../../routes/content/editor-demo"),
            },
            {
              path: "/content/gallery-demo",
              errorElement: <ErrorBoundary />,
              lazy: () => import("../../routes/content/gallery-demo"),
            },
            {
              path: "/content/flow-demo",
              errorElement: <ErrorBoundary />,
              lazy: () => import("../../routes/content/flow-demo"),
            },
            {
              path: "/content/3d-demo",
              errorElement: <ErrorBoundary />,
              lazy: () => import("../../routes/content/three-d-demo"),
            },
            {
              path: "/social-media",
              errorElement: <ErrorBoundary />,
