...
- [x] **Faz 1 (delicate):** Tenant-context middleware (AsyncLocalStorage) + Medusa pg connection patch (`set_config('app.current_tenant')`) — enforcement yok, plumbing
- [x] **Faz 2:** app-layer query scoping (primary) — CMS pilot ✅, content items/snapshots ✅ (2026-07-02)
- [x] **Faz 3:** RLS policy/`FORCE` (DB-sigorta, prod app_user ile aktif) — CMS 3/3 tablo ✅; content 2/2 tablo ✅ (2026-07-02)
